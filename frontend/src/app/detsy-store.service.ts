...
export class DetsyStoreService {
	constructor() {
		DETSY_STORE.set('4a897acc570a4cdba1e18a41e598a0ef', {
			...
			vendor: 'Luis',
			vendorAddress: '0x14395Fc811693eB109De56b5260189cA23625825'
		});
		...
		DETSY_STORE.set('8598d4bc54f247a4bdeee3a6a2d177f3', {
			...
			vendor: 'Jose',
			vendorAddress: '0x14395Fc811693eB109De5655810189cA23625825'
		});
		...
		DETSY_STORE.set('dbb51d51747a442cb4c0b52a74ae3805', {
			...
			vendor: 'Cristiano',
			vendorAddress: '0xd187023249748c894B61eE78E8B47570493dD357'
		});
